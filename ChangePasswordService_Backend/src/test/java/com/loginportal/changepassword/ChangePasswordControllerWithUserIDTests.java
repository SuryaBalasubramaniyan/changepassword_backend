...
//		
//		PasswordHistory password1 = new PasswordHistory();
//		password1.setPwd1("$2a$12$2jDJzTrQ9UOP43LVEyrdweLBe10SA0csWa5EzsHlQm0suxaWv7UqT"); //smallWorld@1
//		password1.setPwd2("$2a$12$2jDJzTrQ9UOP43LVEyrdweLBe10SA0csWa5EzsHlQm0suxaWv7UqS"); //smallWorld
//		
//		User userToDataServiceAgain = new User();
//		userToDataServiceAgain.setUserID(1L);
//		userToDataServiceAgain.setEmailID("abc@gmail.com");
//		userToDataServiceAgain.setPasswordHistory(password1);
//
...
//		userToDataServiceAgain.setUserID(1L);
//		userToDataServiceAgain.setEmailID("abc@gmail.com");
//		userToDataServiceAgain.setPasswordHistory(new PasswordHistory(2L,
...
//	
//	//Test5
//	//new password should not be same as last three old passwords
//	//input:Correct old password
//	//output:new password should not be same as last three old passwords

//	@Test
//	public void testChangePasswordCase5() throws Exception {
//		User userToChangePwdService = new User();
//		userToChangePwdService.setUserID(1L);
//		PasswordHistory dbpasswords = new PasswordHistory();
//		dbpasswords.setPwd3("$2a$12$2jDJzTrQ9UOP43LVEyrdweLBe10SA0csWa5EzsHlQm0suxaWv7UqS"); //smallWorld
//		dbpasswords.setPwd2("$2a$12$/3AH2MLjhuVFh6ZwNvmRKu4lBZbTgmrQnRCkcavisX1RtG9CN374G"); //smallWorld@1
//		dbpasswords.setPwd1("$2a$12$pbAhYIsDZXrAwVaYcVieWe0TMEE68R2yQMolE59haBJVRI.p7yBn2"); //smallWorld@2
//		PasswordHistory newpassword = new PasswordHistory();
//		newpassword.setPwd1("smallWorld@2");
//		newpassword.setPwd2("smallWorld@1");
//		
//		userToChangePwdService.setPasswordHistory(newpassword);
//		
//		User userToDataService = new User();
//		userToDataService.setUserID(1L);
//
...
//
//		httpEntity = new HttpEntity<User>(userToDataServiceAgain);
//		when(restTemplate.exchange("http://localhost:8017/api/data/password-history/update", HttpMethod.POST, httpEntity,
//				new ParameterizedTypeReference<Integer>() {
//				})).thenReturn(new ResponseEntity<>(1, HttpStatus.OK));
//
//		MvcResult mvcResult = mvc.perform(post("/api/change-password").contentType(MediaType.APPLICATION_JSON)
//				.content(mapToJson(userToChangePwdService)).accept(MediaType.ALL_VALUE)).andReturn();
//
//		int apiCallStatus = mvcResult.getResponse().getStatus();
//		String apiCallResponseFromChangePwdService = mvcResult.getResponse().getContentAsString();
